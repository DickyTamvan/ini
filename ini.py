...
def menu():
	...
	print(" "+p+"["+K+"*"+P+"] ID   : "+U+id)
        print(" "+p+"["+K+"*"+P+"]ــــــــــــــــــــــــــــــــــــ")
        print(" "+p+"["+K+"*"+P+"] IP    : "+H+ip)
	print(" "+p+"["+K+"*"+P+"] Status: "+H+"🅿🆁🅴🅼🅸🆄🅼 "+P+"")
	print(" "+p+"["+K+"*"+P+"]ــــــــــــــــــــــــــــــــــــ ")
	print
	print("      [ 🆆🅴🅻🅲🅾🅼🅴 🆃🅾 🅼🆈 🆂🅲🆁🅸🅿🆃 "+H+""+P+":) ]")
	print
	print("      [ SILAHKAN PILIH "+H+""+P+":) ]")
	print(""+p+" "+B+"01 "+P+"> "+K+"Crack Dari Publik")
	print(" "+B+"02 "+P+"> "+K+"Crack Dari Followers")
	print(" "+B+"03 "+P+"> "+K+"Crack Dari Postingan")
	print(" "+B+"04 "+P+"> "+K+"Buka Hasil Crack")
	print(" "+B+"05 "+P+"> "+K+"Setting User-Agents")
	print(" "+B+"06 "+P+"> "+K+"Cek INFO Facebook")
	print(" "+B+"99 "+P+"> "+M+"🅺🅴🅻🆄🅰🆁........ "+M+"")
	print
	ask = raw_input(" "+P+" ["+K+"*"+P+"] Pilih Salah Satu TOD! : ")
	if ask =="":
		menu()
	elif ask == "1" or ask == "01":
		public()
...
def settua():
	...
	if ask =="":
		...
		try:
			...
			uas.write(ua) 
			uas.close()
			print("\n \033[0;97m[\033[0;92m✓\033[0;97m] Berhasil mengganti User-Agent")
			time.sleep(2)
			menu()
		except KeyboardInterrupt:
			exit()
...
def cek_ingfo():
    ...
    try:
#	print(p+"Buruan Ketik/Copy : "+i+"User"+p+"Cara Ambil ID Facebook !!");time.sleep(2)
